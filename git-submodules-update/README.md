...
# INSTALL
    ...
    $ s6 --install git-submodules-update

# USAGE

    # all the list
    $ s6 --plg-run git-submodules-update@directory=/path/to/working/copy/directory/

    # single project
    $ s6 --plg-run git-submodules-update@project=cups,directory=/path/to/working/copy/directory/
